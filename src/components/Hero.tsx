...
import { ShieldCheck, Stethoscope, Plane, ArrowRight } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#002870] via-[#003087]/90 to-transparent"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-md mb-8 shadow-xl">
              ...
              <span className="text-xs font-bold tracking-wider text-emerald-50 uppercase">COOP360 Agencia Integral</span>
            </div>
            ...
            <p className="text-lg lg:text-xl text-blue-100/90 leading-relaxed mb-10 max-w-xl font-light">
              Gestioná tu <strong className="text-white">prepaga</strong>, organizá tus <strong className="text-white">viajes</strong> y protegé lo que más querés con nuestros <strong className="text-white">seguros</strong>.
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#servicios" className="group flex items-center justify-center gap-3 bg-emerald-400 text-[#002870] font-bold px-8 py-4 rounded-full transition-all hover:scale-105 hover:bg-emerald-300">
                Ver servicios <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </a>
              <a href="#contacto" className="flex items-center justify-center px-8 py-4 rounded-full border border-white/30 text-white font-semibold hover:bg-white/10 transition-all">
                Asesoramiento
              </a>
            </div>
          </motion.div>

          {/* Columna Derecha: Tarjetas Glassmorphism (Desktop) */}
          <motion.div 
          ...
          >
            <div className="space-y-4 translate-y-8">
              <FeatureCard icon={<Stethoscope />} title="Prepaga" desc="Cobertura médica completa." />
              <FeatureCard icon={<Plane />} title="Turismo" desc="Viajes sin preocupaciones." />
            </div>
            <div className="space-y-4">
              <FeatureCard icon={<ShieldCheck />} title="Seguros" desc="Protección para tu familia." />
              <div className="p-6 rounded-3xl bg-[#003087]/80 backdrop-blur-xl border border-white/10 flex flex-col items-center justify-center text-center h-full min-h-[180px]">
                ...
                <span className="text-blue-200 text-sm">Socios confían en nosotros</span>
              </div>
            </div>
          </motion.div>
        </div>
